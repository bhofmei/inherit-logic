const scenDefaults = require('./senario.config');
...
module.exports = [
  {
    ...
    referencePhage: [],
    otherPhage: ['{"numToMake": 1, "isWildType": true, "comment": "Determine whether this phage has a wild type or mutant phenotype"}'],
    alternatePhage: ['{"numToMake": [1,1], "isWildType": false, "frameshifts": {"howMany": [1,1], "mixed": "always", "readable": "any", "frameChoice": 0}, "deletions": false, "comment": "Determine whether this phage has a wild type or mutant phenotype", "altStyle": 2}']
  },
  {
    ...
    otherPhage: [],
    alternatePhage: ['{"numToMake":2, "isWildType": false, "frameshifts": {"howMany": [1,1], "mixed": "always", "readable": "any"}, "deletions": false, "comment": "Phage containing a single frameshift mutation", "altStyle": -1}']
  },
  {
    ...
    referencePhage: [scenDefaults.wildtypePhage],
    otherPhage: [scenDefaults.frameShiftPhage],
    alternatePhage: []
  },
  {
    ...
    startingPoint: "",
    referencePhage: [scenDefaults.wildtypePhage],
    otherPhage: ['{"numToMake": 1, "isWildType": false, "frameshifts": {"howMany": [2,2], "mixed": "always", "readable": "can", "frameChoice": 0}, "deletions": false, "comment": "Mutant phage bearing compensating +1 and -1 frameshifts resulting in successful translation and a wild type phenotype"}'],
    alternatePhage: []
  },
  {
    ...
    referencePhage: [scenDefaults.wildtypePhage],
    otherPhage: ['{"numToMake": 8, "isWildType": false, "deletions": true, "comment": "Phage containing a deletion of more than 10 nucleotides"}'],
    alternatePhage: []
  },
  {
    ...
    referencePhage: [scenDefaults.wildtypePhage],
    otherPhage: ['{"numToMake":3, "isWildType": false, "frameshifts": {"howMany": [1,1], "mixed": "never", "readable": "any", "frameChoice": 1}, "deletions": false, "comment": "Mutant phage containing a single +1 frameshift mutation"}'],
    alternatePhage: []
  },
  {
    ...
    referencePhage: [scenDefaults.wildtypePhage, '{"numToMake": 1, "isWildType": false, "frameshifts": {"howMany": [1,1], "mixed": "never", "readable": "any", "frameChoice": -1}, "deletions": false, "comment": "Mutant phage containing a single -1 frameshift"}'],
    otherPhage: ['{"numToMake": 1, "isWildType": "false", "frameshifts": {"howMany": [1,2], "mixed": "never", "readable": "any", "frameChoice": 1}, deletions: false, "comment": "Mutant phage containing one OR two +1 frameshift mutations"}'],
    alternatePhage: []
  },
  {
    ...
    referencePhage: [scenDefaults.wildtypePhage],
    otherPhage: ['{"numToMake":2, "isWildType": false, "frameshifts": {"howMany": [1,1], "mixed": "never", "readable": "any", "frameChoice": 0}, "deletions": false, "comment": "Mutant phage containing a single frameshift mutation"}'],
    alternatePhage: []
  },
  {
  ...
  },
  {
    ...
    referencePhage: [scenDefaults.wildtypePhage],
    otherPhage: ['{"numToMake": 2, "isWildType": false, "frameshifts": {"howMany": [1,1], "mixed": "never", "readable": "any", "frameChoice": 0}, "deletions": false, "comment": "Mutant phage containing a single +1 frameshift mutation"}'],
    alternatePhage:[]
  }
];
